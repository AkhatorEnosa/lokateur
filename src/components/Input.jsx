...
const Input = (props) => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-fit gap-6 p-10 text-sm bg-fixed bg-origin-border bg-left-top bg-no-repeat bg-cover bg-[url('../../bg_image.png')]">
        ...
        <div className="grid grid-cols-8 p-5 items-center w-[50%]">
